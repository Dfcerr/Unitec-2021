...
//bateria
  ...
  pinMode(switchModoAhorro, INPUT_PULLUP);
  pinMode(cc, OUTPUT);
  pinMode(boc, OUTPUT);
...
//      Serial.println("modo ahorro desactivado");
  ...
  if(porcentaje > 90 && m_boton)
    sonido(27);
  else if(porcentaje > 80 && m_boton)
    sonido(26);
  else if(porcentaje > 70 && m_boton)
    sonido(25);
  else if(porcentaje > 60 && m_boton)
    sonido(24);
  else if(porcentaje > 50 && m_boton)
    sonido(23);
  else if(porcentaje > 40 && m_boton)
    sonido(22);
  else if(porcentaje > 30 && m_boton)
    sonido(21);
  else if(porcentaje > 20 && m_boton)
    sonido(20);
  else if(porcentaje > 10 && m_boton)
    sonido(19);
  else if(porcentaje > 5 && m_boton)
    sonido(28);
  else if(porcentaje > 0 && m_boton)
    sonido(29);  
